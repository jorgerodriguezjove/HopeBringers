    ...
    public override void OnGUI(MaterialEditor materialEditor, MaterialProperty[] properties)
    {
        ...
        if (ShowUI == true)
        {
            ...
            if (ShowLighting)
            {
                ...
                GUILayout.Space(10);
                materialEditor.ShaderProperty(_UseTLB, _UseTLB.displayName);
                materialEditor.ShaderProperty(_N_F_EAL, _N_F_EAL.displayName);
            ...
            if (shader_name == "default_d" || shader_name == "tessellation_d" || shader_name == "default_ft" || shader_name == "tessellation_ft")
            {
                ...
                materialEditor.ShaderProperty(_N_F_DCS, _N_F_DCS.displayName);
