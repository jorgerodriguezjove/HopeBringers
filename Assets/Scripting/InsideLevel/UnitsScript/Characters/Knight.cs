    ...
    public override void ShowAttackEffect(UnitBase _unitToAttack)
    {
        ...
        if (pushWider)
        {
            if (currentFacingDirection == FacingDirection.North)
            {
                ...
                {
                    if (currentUnitsAvailableToAttack.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineRight[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 && 
                            ...
                            myCurrentTile.tilesInLineRight[0].tilesInLineUp.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineRight[0].tilesInLineUp, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineLeft.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            ...
                            myCurrentTile.tilesInLineLeft[0].tilesInLineUp.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineLeft[0].tilesInLineUp, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineLeft.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineLeft[0].unitOnTile != null &&
                            myCurrentTile.tilesInLineLeft[0].tilesInLineDown.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineLeft[0].tilesInLineDown, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineRight.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineRight[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineRight[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            ...
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineRight[0].unitOnTile != null
                            && myCurrentTile.tilesInLineLeft[0].tilesInLineDown.Count > 0 && 
                            myCurrentTile.tilesInLineRight[0].tilesInLineDown.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineRight[0].tilesInLineDown, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineUp.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            ...
                            && myCurrentTile.tilesInLineUp[0].tilesInLineRight.Count > 0)
                        {
                            ...
                            if(CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineUp[0].tilesInLineRight, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineDown.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            ...
                            && myCurrentTile.tilesInLineDown[0].tilesInLineRight.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineDown[0].tilesInLineRight, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineUp.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineUp[0].unitOnTile != null
                            && myCurrentTile.tilesInLineUp[0].tilesInLineLeft.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineUp[0].tilesInLineLeft, damageMadeByPush, damageMadeByFall) != null)
                            {
                ...
                if (_unitToAttack.myCurrentTile.tilesInLineDown.Count > 0 && currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown[0].unitOnTile != null)
                {
                    if (currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown[0].unitOnTile != null)
                    {
                        ...
                        if (!isMovingorRotating && currentUnitsAvailableToAttack.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown.Count > 0 &&
                            currentUnitsAvailableToAttack[0].myCurrentTile.tilesInLineDown[0].unitOnTile != null
                            && myCurrentTile.tilesInLineDown[0].tilesInLineLeft.Count > 0)
                        {
                            ...
                            if (CalculatePushLogic(tilesToPush, myCurrentTile.tilesInLineDown[0].tilesInLineLeft, damageMadeByPush, damageMadeByFall) != null)
                            {
